    ...
    >
      ...
      />
        ...
        <div className="lg:flex-grow lg:pr-4 lg:mr-14 flex flex-col md:mb-0 items-center text-center xl:scale-105">
          ...
          >
            Hello , I am <span className="text-dark-orange">Balaji</span>
          </h2>
          <div
            data-aos="zoom-in-up"
            data-aos-duration="1500"
          ...
          >
            <button className="inline-flex font-medium text-white bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 border-2 border-white py-3 px-7 focus:outline-none hover:bg-cornsilk hover:border-dark-white hover:text-black rounded-full text-md xl:px-10">
              <Link
                to="contact"
                spy={true}
                smooth={true}
